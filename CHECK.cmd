...
%NUNICOM_JAVA_HOME%\bin\java -jar NUnicom-1.0-SNAPSHOT.jar %NUNICOM_OPER% %NUNICOM_NEWLAND_USER% %NUNICOM_NEWLAND_PASS% %NUNICOM_VPN_ENTRY% %NUNICOM_VPN_USER% %NUNICOM_VPN_PASS%
